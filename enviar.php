...
// Mudar Aqui o e-mail
$email_envio = "projetonando@cobrainformatica.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "Provisoria123"; // Senha do e-mail

$site_name = "Cobra informática"; // Nome do Site
$site_url = "https://cobrainformatica.com/"; // URL do Site

$host_smtp = "smtp.cobrainformatica.com"; // HOST SMTP Ex: smtp.domain.com.br
